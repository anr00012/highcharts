 ...
 * @product highcharts highstock
 *
 * @description A `scatter` series. If the [type](#series.scatter.type) option
 *  is
...
export interface ScatterSeriesOptions extends LineSeriesOptions {
     ...
     */
    data: Array<number|Array<(number|string), (number|null)>|null|ScatterSeriesDataOptions>;
    ...
    marker: ScatterSeriesMarkerOptions;
 ...
 * @product highcharts highstock highmaps
 *
 * @optionparent series.scatter.tooltip
 */
interface ScatterSeriesTooltipOptions{
...
/**
 *
 * @optionparent series.scatter.marker
 */
interface ScatterSeriesMarkerOptions{
